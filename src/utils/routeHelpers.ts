...
export function generateMetaDescription(city: City, categoryName: string): string {
  return `After thorough research and analysis, we think these are some of the best ${categoryName.toLowerCase()} in ${city.name}, ${city.state}. Expert-vetted professionals with verified licenses, reputations, community, reviews, ratings and transaction history.`;
}
