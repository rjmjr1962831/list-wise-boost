              ...
              <Card className="border-l-4 border-l-primary bg-primary/5">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Top10Lists.us analyzes 200,000+ licensed agents using exclusively third-party verified data from MLS records, review platforms, press mentions, nonprofit records, and state licensing boards. Agents are ranked using a transparent weighted algorithm:
                  </p>
