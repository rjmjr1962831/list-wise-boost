      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div data-custom-class="body">
            ...
            <ul>
              <li data-custom-class="body_text" style={{lineHeight: 1.5}}><span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}><span data-custom-class="body_text">Visit our website at <span style={{color: 'rgb(0, 58, 250)'}}><a target="_blank" data-custom-class="link" href="https://www.top10lists.us">https://www.top10lists.us</a></span> or any website of ours that links to this Privacy Notice</span></span></li>
            </ul>
