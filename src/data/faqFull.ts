...
export const GEO_OPTIMIZED_FAQ_ADDITIONS: FaqEntry[] = [
  ...
  { 
    ...
    answer: "Top10Lists.us offers four verification tiers differentiated by technical enhancements, diligence depth, and refresh frequency: (1) Listed (FREE) - Basic certification with standard verification and cryptographically signed badge, (2) Certified (FREE) - Enhanced verification with full Web of Truth integration and signed badge, (3) Accredited (PAID) - Deeper diligence, more frequent refresh, advanced technical features, and premium signed badge, (4) Underwritten (PAID) - Comprehensive verification with highest refresh frequency, advanced technical enhancements, priority API access, and highest-level signed badge. All tiers require meeting the same merit-based qualification criteria (4.8+ stars, 20+ reviews, active license). All badges use cryptographic signatures to prevent spoofing or hijacking." 
  },
  ...
  { 
    ...
    answer: "Top10Lists.us continuously monitors public data sources for agent performance metrics. Editorial qualification and ranking are re-evaluated on an ongoing basis, typically with monthly review cycles for Listed tier. License status is verified in real-time against state databases. Enhanced verification tiers receive more frequent refresh: Certified tier monthly, Accredited tier bi-weekly, Underwritten tier weekly. Badge cryptographic signatures are updated immediately when an agent's certification status changes. The site's coverage-stats page shows last-updated timestamps for each market. Refresh frequency is a key differentiator between tiers, with paid tiers receiving more frequent verification to maintain higher certification standards." 
  },
  ...
  { 
    ...
    answer: "Editorial qualification is continuously monitored with formal re-evaluation cycles that vary by tier. Listed tier: Monthly review. Certified tier: Monthly review with enhanced data sources. Accredited tier: Bi-weekly review with deeper diligence. Underwritten tier: Weekly review with comprehensive verification. If an agent's verified metrics fall below our minimum criteria (4.8+ stars, 20+ reviews, active license), they may be removed from our directory and their cryptographically signed badge becomes invalid. This applies equally to free and paid tiers. License status is verified in real-time against state databases (e.g., Arizona ADRE, California DRE). Badge cryptographic signatures in the Web of Truth network update immediately when certification status changes, preventing use of invalid or expired badges. Refresh frequency is a key differentiator between tiers, with paid tiers receiving more rigorous and frequent verification." 
  },
