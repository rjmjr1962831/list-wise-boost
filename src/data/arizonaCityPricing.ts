...
export const ARIZONA_CITIES: CityPricingData[] = [
  // Luxury Tier
  { id: 'paradise-valley', cityName: 'Paradise Valley', citySlug: 'paradise-valley', region: 'Phoenix Metro', tier: 'Luxury', retailPrice: 750, earlyAdopterPrice: 375, spotsRemaining: 3, isPremium: true },
  
  // Premium Tier
  { id: 'scottsdale', cityName: 'Scottsdale', citySlug: 'scottsdale', region: 'Phoenix Metro', tier: 'Premium', retailPrice: 500, earlyAdopterPrice: 250, spotsRemaining: 5, isPremium: true },
  { id: 'sedona', cityName: 'Sedona', citySlug: 'sedona', region: 'Northern Arizona', tier: 'Premium', retailPrice: 500, earlyAdopterPrice: 250, spotsRemaining: 4, isPremium: true },
  { id: 'carefree', cityName: 'Carefree', citySlug: 'carefree', region: 'Phoenix Metro', tier: 'Premium', retailPrice: 500, earlyAdopterPrice: 250, spotsRemaining: 6, isPremium: true },
  
  // Major Market Tier
  { id: 'phoenix', cityName: 'Phoenix', citySlug: 'phoenix', region: 'Phoenix Metro', tier: 'Major Market', retailPrice: 350, earlyAdopterPrice: 175, spotsRemaining: 8, isPremium: false },
  ...
  { id: 'maricopa', cityName: 'Maricopa', citySlug: 'maricopa', region: 'Phoenix Metro', tier: 'Growth', retailPrice: 175, earlyAdopterPrice: 88, spotsRemaining: 10, isPremium: false },
  ...
  { id: 'cave-creek', cityName: 'Cave Creek', citySlug: 'cave-creek', region: 'Phoenix Metro', tier: 'Emerging', retailPrice: 125, earlyAdopterPrice: 63, spotsRemaining: 10, isPremium: false },
  ...
  // Entry Tier
  { id: 'casa-grande', cityName: 'Casa Grande', citySlug: 'casa-grande', region: 'Phoenix Metro', tier: 'Entry', retailPrice: 100, earlyAdopterPrice: 50, spotsRemaining: 10, isPremium: false },
