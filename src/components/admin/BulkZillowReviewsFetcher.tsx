...
/**
 * @deprecated This component uses Apify actors (bulk-fetch-zillow-reviews)
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-xl font-bold text-destructive mb-2">
            ⚠️ DEPRECATED - Bulk Zillow Reviews Fetcher
          </h2>
          <p className="text-muted-foreground mb-4">
            This component has been disabled because it uses deprecated Apify actors:
          </p>
          <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 mb-4">
            <li><code>bulk-fetch-zillow-reviews</code> → uses memo23 Apify actor</li>
          </ul>
