...
/**
 * @deprecated This component uses Apify actors (capture-zillow-rankings)
 * which have been deprecated in favor of the Exa→Firecrawl pipeline.
 * 
 * Ranking capture via Apify is no longer supported.
 */
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-xl font-bold text-destructive mb-2">
            ⚠️ DEPRECATED - Zillow Ranking Capture
          </h2>
          <p className="text-muted-foreground mb-4">
            This component has been disabled because it uses deprecated Apify actors:
          </p>
          <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 mb-4">
            <li><code>capture-zillow-rankings</code> → uses getdataforme Apify actor</li>
          </ul>
