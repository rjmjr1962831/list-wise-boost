...
/**
 * @deprecated This component uses Apify actors (fetch-agenscrape-agents, fetch-apify-zillow-cheerio)
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-xl font-bold text-destructive mb-2">
            ⚠️ DEPRECATED - AgenScrape Importer
          </h2>
          ...
          <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 mb-4">
            ...
            <li><code>fetch-apify-zillow-cheerio</code> → uses memo23 Apify actor</li>
          </ul>
