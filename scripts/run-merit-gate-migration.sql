-- Run each block separately in Supabase SQL Editor if the full migration fails.
-- Block 1: Pipedrive sync trigger
...
-- Block 2: get_neighborhood_ids_with_qualified_agents
...
-- Block 3: get_neighborhood_active_agents
