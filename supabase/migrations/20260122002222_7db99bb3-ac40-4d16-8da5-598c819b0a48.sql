...
-- Update search_location function to include neighborhood aliases
...
BEGIN
  ...
  -- Neighborhood aliases (priority 3) - NEW
  SELECT 
    'neighborhood'::text as result_type,
    na.alias_name as neighborhood,  -- Show the alias name user searched for
    nc.neighborhood_slug as neighborhood_slug,  -- But use canonical slug for routing
    nc.city_area as city_area,
    nc.city_area_slug as city_area_slug,
    nc.primary_zip as primary_zip,
    nc.state as state,
