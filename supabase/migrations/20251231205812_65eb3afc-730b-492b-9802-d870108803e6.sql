-- Fix the trigger function - use proper unique constraint handling
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    IF NOT EXISTS (
      ...
      -- Use simple insert with conflict on professional_id
  ...
  IF TG_OP = 'UPDATE' THEN
    IF (
      ...
      OLD.social_tiktok IS DISTINCT FROM NEW.social_tiktok
    ) THEN
