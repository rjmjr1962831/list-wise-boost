...
DROP TRIGGER IF EXISTS trigger_update_agent_bot_summary ON public.cloudflare_request_logs;
...
DROP POLICY IF EXISTS "Agents can manage their notification preferences" ON public.agent_bot_notification_preferences;
DROP POLICY IF EXISTS "Agents can view their bot summaries" ON public.agent_bot_visit_summary;
DROP POLICY IF EXISTS "Authenticated users can view all bot summaries" ON public.agent_bot_visit_summary;
DROP POLICY IF EXISTS "Service role can manage summaries" ON public.agent_bot_visit_summary;
DROP POLICY IF EXISTS "Service role can manage notification preferences" ON public.agent_bot_notification_preferences;
