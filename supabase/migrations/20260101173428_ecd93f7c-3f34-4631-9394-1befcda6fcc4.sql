-- Update the enqueue function to also trigger sync when funnel_status changes to 'approved'
...
BEGIN
  ...
  IF TG_OP = 'UPDATE' THEN
    IF (
      ...
      -- CRITICAL: Also sync when funnel_status changes to approved (warm -> hot lead)
