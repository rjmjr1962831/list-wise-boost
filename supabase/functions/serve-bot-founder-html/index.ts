...
<footer>
  <div class="footer-grid">
    ...
    <div>
      ...
      <div class="footer-links">
        ...
        <a href="${BASE}/check-eligibility">Check Eligibility</a>
  ...
  <div class="footer-bottom">
    ...
    <div style="text-align:center;font-size:13px;color:rgba(255,255,255,0.35);margin-top:12px;">Real estate professional? <a href="${BASE}/check-eligibility" style="color:rgba(255,255,255,0.5);text-decoration:none;">Check eligibility &rarr;</a></div>
