...
serve(async (req) => {
  ...
  try {
    ...
    const structuredData = {
      ...
      "description": `AI and human curated list of the top 10 real estate agents in ${cityData.name}, ${cityData.state}. Qualified with 4.8+ star ratings and 50+ verified reviews.`,
