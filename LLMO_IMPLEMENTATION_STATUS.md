...
|------|------|---------|----------|--------------|
| `og-image.png` | 1200×630px | Home page social sharing | `public/og-image.png` | Dark blue gradient, "Top 10 Real Estate Agents in Arizona", "Invitation-Only • Data-Verified • 10+ Verified Reviews (last 24 mo)" |
