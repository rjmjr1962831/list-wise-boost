# Gemini: Nightly Takeaways — Private Repo Only (Not Public)

Use this prompt (or add it to your Gemini project/instructions) so that when Robert says **"takeaways"** or **"run takeaways"**, Gemini produces the daily takeaways and posts them in the **private** knowledge repo only. These documents must **not** be in the public repo or pushed to staging/main.
...
2. **Save** the content as a single file:
   - **Path:** `docs/takeaways/GEMINI_TAKEAWAYS_DD-MM-YY.md`
   - **Date in filename:** Use today’s date as DD-MM-YY (e.g. 16-02-26 for 16 February 2026).
   - **Example:** For 16 February 2026, the file is `docs/takeaways/GEMINI_TAKEAWAYS_16-02-26.md`.
...
3. **Where to put it (important):** Push this file **only** to the private knowledge repo:
   ...
   - **Path in repo:** `docs/takeaways/GEMINI_TAKEAWAYS_DD-MM-YY.md` (e.g. `docs/takeaways/GEMINI_TAKEAWAYS_16-02-26.md` for 16 February 2026).
